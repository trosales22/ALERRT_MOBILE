...
public class CommentsActivity extends AppCompatActivity {
    ...
    private List<CommentDO> commentsDataObjectList;
                                ...
                                try {
                                    ...
                                    for(int a = 0; a < comments.length(); a++) {
                                        ...
                                        for (int b = 0; b < commenterInfo.length(); b++) {
                                            ...
                                            comment.setCommentBy(commenterInfo_object.getString("Fullname"));

                                            CommentDO commentsDataObject = new CommentDO(
                                    ...
                                    adapter = new CommentsAdapter(commentsDataObjectList,getApplicationContext());
